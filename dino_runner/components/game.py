...
class Game:
    ...
    def print_menu_elements(self):
        ...
        if self.death_count == 0:
            ...
            text, text_rect = tex_utils.get_centered_message('Deaths: ' + str(self.death_count), 550, 50)
            self.screen.blit(text, text_rect)
            text, text_rect = tex_utils.get_centered_message('Points obtained: ' + str(self.points), 550, 90)
            self.screen.blit(text, text_rect)
